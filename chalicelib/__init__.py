...
class Storage(object):
    ...
    def __init__(self, table):
        ...
        :param table: A boto3 dynamodb table resouce objetc
        """
    ...
    @classmethod
    def from_env(cls):
        """Create table from the enviroment.
        ...
        reference. We default to '', wich will happen when we run 
        ``challice package`` since it loads the application, and no
